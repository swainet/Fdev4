...
(function($, undefined){
    ...
    $.fn.scrollTo = function(target, duration, settings){
        ...
        return scrollable(this).each(function(){
            ...
            $.each(settings.axis.split(''), function(i, axis){
                ...
                if (!i && settings.queue) {
                    ...
                    if (old != attr[key]) {
						...
						$elem.animate(attr, duration, settings.easing, settings.onAfterFirst &&
				        function(){
				            settings.onAfterFirst.call(this, target, settings);
				        });
                    }
            ...
            $elem.animate(attr, duration, settings.easing, settings.onAfter &&
	        function(){
	            settings.onAfter.call(this, target, settings);
	        });
        }).end();
    };
