...
(function($){
    ...
    $.widget("ui.menu", {
        ...
        refresh: function(){
			...
			.children("a").attr("tabindex", -1) // mouseenter doesn't work with event delegation;
        },
        ...
        activate: function(event, item){
            ...
            this.active = item.addClass("ui-state-hover").eq(0).children("a").attr("id", "ui-active-menuitem").end();
        ...
        deactivate: function(){
            ...
            this.active.removeClass("ui-state-hover").children("a").removeAttr("id");
            this._trigger("blur");
            this.active = null;
        },
