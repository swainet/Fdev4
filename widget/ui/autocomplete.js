...
(function($, undefined){
    ...
    $.widget("ui.autocomplete", {
        ...
        _create: function(){
            ...
            this.element.addClass("ui-autocomplete-input").attr("autocomplete", "off").attr({ // TODO verify these actually work as intended
                role: "textbox",
                "aria-autocomplete": "list",
                "aria-haspopup": "true"
            }).bind("keyup.autocomplete", function(event){ //优化中文输入法支持，改keydown为keyup。by Edgar 110607
            ...
            }).zIndex(this.element.zIndex() + 1).css({// workaround for jQuery bug #5781 http://dev.jquery.com/ticket/5781
                top: 0,
                left: 0
            }).hide().data("menu");
            if ($.fn.bgiframe) {
