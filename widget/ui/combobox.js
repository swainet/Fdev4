    ...
    $.widget('ui.combobox', {
        ...
        _create: function(){
            ...
            if (o.multiple) {
                ...
                html.push('<input class="result" type="text" autocomplete="off"' + (o.editable ? '' : 'readonly="readonly"') + '/>');
            }
        ...
        _buildEvent: function(){
            ...
            //closable?
            if (!o.closable) {
                $([self.result[0], self.trigger[0], self.panel[0]]).bind('mousedown.combobox', function(e){
                    e.stopPropagation();
                });
            }
        },
        ...
        toggle: function(e){
            ...
            if (self.panel.css('display') === 'none') {
                ...
                if (!o.closable) {
                    $(document).one('mousedown.combobox', function(){
                        self.panel.hide();
                    });
                }
            }
         ...
         * @param {jQuery} node		是否携带项的节点，提高效率
         */
