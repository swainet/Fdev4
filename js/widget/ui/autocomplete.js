 ...
 *	jquery.ui.menu.js
 * @update 2011.06.07 优化中文输入法支持，改keydown为keyup ---- Edgar
 */
...
(function($, undefined){
    ...
    $.widget("ui.autocomplete", {
        ...
        _create: function(){
            ...
            this.element.addClass("ui-autocomplete-input").attr("autocomplete", "off") // TODO verify these actually work as intended
.attr({
                role: "textbox",
            ...
            this.menu = $("<ul></ul>").addClass("ui-autocomplete").appendTo($(this.options.appendTo || "body", doc)[0]) // prevent the close-on-blur in case of a "slow" click on the menu (long mousedown)
.mousedown(function(event){
            ...
            }).zIndex(this.element.zIndex() + 1) // workaround for jQuery bug #5781 http://dev.jquery.com/ticket/5781
.css({
                top: 0,
                left: 0
            }).hide().data("menu");
